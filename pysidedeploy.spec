...
input_file = mediasorter.py

# directory where the executable output is generated
exec_directory = dist/windows

# path to the project file relative to project_dir
project_file = mediasorter.pyproject

# application icon
icon = assets/icons/mediasorter_icon.ico

[python]

# python path
python_path = C:\Users\bryan\repos\mediasorter\.bundle-venv\Scripts\python.exe
